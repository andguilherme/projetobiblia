    ...
    <nav>
        ...
        <div class="menu-bar mobile">
            <ul>
                <li><a href="gn2.php?livro=<?php echo $_GET['livro'] ?>&mcapitulo=<?php echo $_GET['mcapitulo'] ?>&versaoLv=5" title="Nova Tradução da Linguagem de Hoje">NTLH</a></li>
                <li><a href="gn2.php?livro=<?php echo $_GET['livro'] ?>&mcapitulo=<?php echo $_GET['mcapitulo'] ?>&versaoLv=1" title="Almeida Revista e Atualizada">ARA</a></li>
                <li><a href="gn2.php?livro=<?php echo $_GET['livro'] ?>&mcapitulo=<?php echo $_GET['mcapitulo'] ?>&versaoLv=2" title="Almeida Revisada e Corrigida">ARC</a></li>                
                <li><a href="gn2.php?livro=<?php echo $_GET['livro'] ?>&mcapitulo=<?php echo $_GET['mcapitulo'] ?>&versaoLv=6" title="Nova Versão Internacional">NVI</a></li>
    ...
    <div id="corpo">
        <div class="sel_livros selNova">
            <form method="GET" action="" name="livronome" id="livronome">
                ...
                <select name="livro" id="tst" onchange="this.form.submit()">
                    ...
                    /* SELECT ver_titulo from titulos WHERE  ver_liv_id=? AND ver_capitulo=?*/
                    ...
                    <optgroup label="Antigo Testamento">
                        ...
                        <option value="32" <?php if ($livro == '32') echo "selected=\"selected\""; ?>>Jonas</option>
                        <option value="33" <?php if ($livro == '33') echo "selected=\"selected\""; ?>><?php echo iconv('UTF-8', 'ISO-8859-1', 'Miquéias'); ?></option>
                    ...
                    <optgroup label="Novo Testamento">
                        ...
                        <option value="53" <?php if ($livro == '53') echo "selected=\"selected\""; ?>>2 Tessalonissences</option>
                ...
                <select name="versaoLv" id="versaoLv" onchange="this.form.submit()">
                    <option value="1" <?php if ($vers == '1') echo "selected=\"selected\""; ?>>Almeida Revista e Atualizada - ARA</option>
                     <option value="2" <?php if ($vers == '2') echo "selected=\"selected\""; ?>>
                    Almeida Revisada e Corrigida - ARC</option>
        ...
        <div class="textoLv">
            ...
            foreach ($stmt->fetchAll() as $k) {
                  ...
                  if ($k['ver_capitulo'] == '1'/*$capitulo*/ AND $k['ver_versiculo'] == '17') {
            ...
            /*Acho que essa lógica funciona para colocar titulos nos capítulos, mas devera
            ser criado uma tabela título com id, id do livro, o id do capitulo e ver_titulo. Tb tem que criar
            um campo 'fimDeSecao' na tabela versículos para testar o fim de cada seção */
